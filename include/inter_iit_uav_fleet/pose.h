#ifndef INTER_IIT_UAV_FLEET_POSE_H
#define INTER_IIT_UAV_FLEET_POSE_H

#include <tf/tf.h>
#include <GeographicLib/AzimuthalEquidistant.hpp>

// This function takes the center of the box and using the odometry and GPS location of quad, it calculates the GPS
...
void findPose(const cv::Point &center, inter_iit_uav_fleet::Pose &box_pose)
{
  ...
  // Calculating and storing the GPS coordinates of the box center using the above calculated coordinates and GPS data
  // of quadrotor
